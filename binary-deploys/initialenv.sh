...
#>>> 名称解析
cat <<-EOF >>/etc/hosts
LOADBALANCER    k8s-prod-loadbalancer
MASTER1         k8s-prod-master-01
MASTER2         k8s-prod-master-02
MASTER3         k8s-prod-master-03
WORKER1         k8s-prod-worker-01
WORKER2         k8s-prod-worker-02
EOF
